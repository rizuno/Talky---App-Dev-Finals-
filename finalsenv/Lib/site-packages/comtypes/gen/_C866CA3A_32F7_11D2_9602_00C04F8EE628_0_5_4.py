...
__all__ = [
    'DISPID_SRRAudio', 'ISpRecoContext', 'SPEI_RESERVED5',
    'ISpeechGrammarRule', 'DISPID_SRCEventInterests', 'SASPause',
    'ISpeechRecoContext', 'SVP_12', 'DISPID_SDKOpenKey',
    'DISPID_SpeechPhraseElements', 'SpeechCategoryAudioOut',
    'SPSVerb', 'DISPID_SpeechRecoResult2',
    'SpPhoneticAlphabetConverter', 'DISPID_SpeechAudioFormat',
    ...
    'SAFT11kHz16BitStereo', 'SP_VISEME_3', 'SP_VISEME_9',
    'DISPID_SPERetainedSizeBytes', 'SDA_No_Trailing_Space',
    'DISPID_SPIStartTime', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SPPId',
    'SpeechGrammarState', 'DISPID_SRCResume',
    'DISPID_SpeechLexiconProns',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SRSAudioStatus',
    'DISPID_SPAPhraseInfo', 'SPCONTEXTSTATE', 'SPEI_PHRASE_START',
    'DISPID_SRGId', 'DISPID_SVSInputSentencePosition',
    'DISPID_SRGCmdLoadFromResource', 'SpSharedRecoContext',
    'SECFIgnoreCase', 'SVSFParseSapi',
    'DISPID_SpeechPhraseReplacement',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SRDisplayUI',
    'SPEI_ADAPTATION', 'DISPID_SPELexicalForm', 'SpeechWordType',
    'DISPID_SLGenerationId', 'SPEI_END_SR_STREAM', 'SPCS_ENABLED',
    'SVP_7', 'DISPID_SMSGetData', 'SAFTADPCM_22kHzStereo',
    'DISPID_SASState', 'IInternetSecurityMgrSite', 'SRESoundStart',
    'eLEXTYPE_RESERVED8', 'SVEStartInputStream', 'ISpeechVoiceStatus',
    'SSFMOpenForRead', 'DISPID_SPILanguageId', 'eWORDTYPE_ADDED',
    'SREStateChange', 'SPINTERFERENCE_NOSIGNAL', 'UINT_PTR',
    'SpeechInterference', 'SDTReplacement', 'SAFT8kHz16BitMono',
    'SVEWordBoundary', 'DISPID_SABIBufferSize', 'DISPID_SPIEngineId',
    'SPEI_MAX_SR', 'DISPID_SVEStreamEnd', 'DISPID_SWFEBitsPerSample',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SPRsItem',
    'DISPID_SpeechPhraseReplacements', 'SDA_One_Trailing_Space',
    'ISpeechRecoGrammar', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SRRGetXMLResult', 'SREStreamStart',
    'SpeechGrammarTagWildcard', 'DISPID_SVSRunningState',
    'DISPID_SVSInputWordLength', 'SECFIgnoreWidth',
    'ISpeechPhraseReplacements', 'SAFTCCITT_ALaw_22kHzStereo',
    'SpStream', 'SPEI_RESERVED3', 'SVESentenceBoundary',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SAFType',
    'DISPID_SPRuleChildren', 'SPLOADOPTIONS',
    'DISPID_SVGetAudioInputs', 'SPAO_NONE', 'ISpeechAudioBufferInfo',
    'SpeechVoicePriority', 'ISpRecoContext2', 'DISPID_SPAsCount',
    'eLEXTYPE_PRIVATE20', 'SDTDisplayText',
    'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SLRemovePronunciation', 'DISPID_SRCEAdaptation',
    'DISPID_SLPPhoneIds', 'SAFTDefault',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SPIGetDisplayAttributes',
    'SVP_1', 'STSF_AppData', 'SPWT_DISPLAY', 'SPEI_FALSE_RECOGNITION',
    'SPBO_PAUSE', 'SWPUnknownWordPronounceable', 'SP_VISEME_11',
    'SRERecognition', 'SPEI_RECO_STATE_CHANGE', 'SPGRAMMARSTATE',
    'DISPID_SRCEPhraseStart', 'SPCT_DICTATION', 'DISPID_SPIGetText',
    'SPWORD', 'SPFILEMODE', 'SITooFast', 'DISPID_SRGRecoContext',
    'DISPID_SOTIsUISupported', 'DISPID_SRCCmdMaxAlternates',
    'DISPID_SpeechBaseStream', 'DISPID_SPAs_NewEnum',
    'DISPID_SGRsItem', 'DISPID_SpeechWaveFormatEx',
    'SPWORDPRONUNCIATION', 'DISPID_SGRName', 'SSSPTRelativeToStart',
    'DISPID_SPEActualConfidence', 'SDA_Two_Trailing_Spaces',
    'SECLowConfidence', 'DISPID_SRGDictationLoad', '_RemotableHandle',
    'SPRS_ACTIVE', 'SAFTTrueSpeech_8kHz1BitMono',
    'ISpeechResourceLoader', 'SpLexicon',
    'ISpeechLexiconPronunciation', 'SVEPhoneme',
    'DISPID_SPIAudioSizeTime', 'ISpeechXMLRecoResult',
    'DISPID_SLWsItem', 'SPEI_SENTENCE_BOUNDARY',
    'Speech_StreamPos_RealTime', 'SVP_19', 'SECHighConfidence',
    'SpPhoneConverter', 'DISPID_SFSClose', 'SSTTDictation',
    'DISPID_SDKSetLongValue', 'SPEI_PROPERTY_NUM_CHANGE',
    'DISPID_SADefaultFormat', 'SPPS_LMA', 'SpNullPhoneConverter',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpeechPhraseAlternates', 'SLODynamic', 'SPSInterjection',
    'DISPID_SOTCreateInstance', 'DISPID_SGRSTWeight', 'SVSFIsXML',
    'SVSFIsNotXML', 'DISPID_SGRSTPropertyId',
    'DISPID_SpeechPhraseAlternate', 'SPAUDIOSTATUS',
    'DISPID_SRGCmdSetRuleState', 'SECFNoSpecialChars',
    'SSSPTRelativeToCurrentPosition', 'SP_VISEME_7',
    'SpeechMicTraining', 'SAFTADPCM_8kHzStereo', 'SPAUDIOOPTIONS',
    'DISPID_SRGCmdLoadFromMemory', 'SAFT24kHz16BitMono',
    'SpeechAudioState', 'DISPID_SRCState', 'SLTApp',
    'ISpeechRecoResultTimes', 'SpVoice', 'eLEXTYPE_PRIVATE12',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SpeechFileStream',
    'DISPID_SGRSTsCount', 'SpeechAudioFormatGUIDWave', 'SPAUDIOSTATE',
    'ISpPhrase', 'DISPID_SRGReset', 'SAFT22kHz8BitStereo',
    'SAFT12kHz16BitStereo', 'DISPID_SPRulesItem',
    'eLEXTYPE_VENDORLEXICON', 'SWTAdded', 'SVP_20', 'SVP_6',
    'DISPID_SVEEnginePrivate', 'DISPID_SRGCmdLoadFromObject',
    'SECFEmulateResult', 'SPPS_SuppressWord', 'SPDKL_DefaultLocation',
    'ISpNotifySource', 'DISPID_SPPBRestorePhraseFromMemory',
    'SP_VISEME_0', 'DISPID_SRAudioInputStream', 'SRAImport', 'SVP_21',
    'ISpeechRecoResultDispatch', 'SpeechRecoContextState',
    'DISPID_SPCLangId', 'SP_VISEME_4', 'DISPID_SPIReplacements',
    'ISpGrammarBuilder', 'SpeechRuleState', 'ISpeechCustomStream',
    'SpeechGrammarWordType', 'SVEAudioLevel', 'SRSInactiveWithPurge',
    'SpeechRecoProfileProperties', 'DISPID_SPIProperties',
    'DISPID_SPPsItem', 'DISPID_SVSpeakStream', 'SVSFNLPSpeakPunc',
    'DISPID_SPIAudioSizeBytes', 'ISpSerializeState',
    'DISPID_SWFEChannels', 'SPEI_MIN_TTS', 'SPGS_ENABLED',
    'SPCT_SLEEP', 'STCLocalServer', 'DISPID_SBSFormat',
    'DISPID_SVSLastBookmark', 'ISpeechPhraseAlternate',
    'ISpeechObjectTokens', 'SPAS_CLOSED', 'SDKLDefaultLocation',
    'SpeechFormatType', 'SPVISEMES', 'eLEXTYPE_RESERVED10',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SPPEngineConfidence',
    'SpeechAddRemoveWord', 'SpeechCategoryAudioIn',
    'DISPID_SGRSTRule', 'DISPID_SVDisplayUI', 'eLEXTYPE_RESERVED4',
    'DISPID_SOTSetId', 'DISPID_SRIsUISupported',
    'DISPID_SRCRetainedAudio', 'ISpeechGrammarRules',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'ISpStreamFormatConverter', 'DISPID_SRSetPropertyString',
    'DISPID_SPPName', 'SPAR_Low', 'DISPID_SPEAudioSizeTime',
    'SPPS_RESERVED3', 'SPXRO_Alternates_SML', 'SPEI_SOUND_END',
    'DISPID_SPEPronunciation', 'DISPID_SDKDeleteValue',
    'DISPID_SRSCurrentStreamNumber',
    'DISPID_SpeechObjectTokenCategory', 'SPAS_RUN',
    'eLEXTYPE_PRIVATE15', 'SAFTCCITT_uLaw_22kHzMono', 'SPWF_SRENGINE',
    'DISPID_SGRSTText', 'DISPID_SLPs_NewEnum', 'SPBINARYGRAMMAR',
    'SPEI_START_INPUT_STREAM', 'DISPID_SABufferNotifySize',
    'ISpeechLexiconWords', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpAudioFormat', 'SAFTCCITT_ALaw_8kHzMono',
    'SpeechTokenKeyAttributes', 'DISPID_SASCurrentDevicePosition',
    'ISpeechPhraseRule', 'SVSFParseAutodetect',
    'DISPID_SRCEFalseRecognition', 'DISPID_SPEAudioStreamOffset',
    'ISpMMSysAudio', 'eLEXTYPE_APP', 'DISPID_SPACommit',
    'DISPID_SGRSAddSpecialTransition', 'SPCT_SUB_DICTATION',
    'ISpEventSource', 'DISPID_SVPriority', 'DISPID_SDKDeleteKey',
    'STCInprocServer', 'SGRSTTWord', 'DISPID_SpeechLexiconWords',
    'eLEXTYPE_RESERVED9', 'SPEI_MIN_SR',
    'DISPID_SRRDiscardResultInfo', 'WAVEFORMATEX', 'DISPID_SPRuleId',
    'SPVPRI_ALERT', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SRCEEndStream', 'eLEXTYPE_PRIVATE17', 'SPRULE',
    'DISPID_SRCEAudioLevel', 'DISPID_SMSAMMHandle',
    'SAFTADPCM_22kHzMono', 'SPEI_VISEME',
    'SpeechPropertyAdaptationOn', 'eLEXTYPE_PRIVATE7',
    'SPSEMANTICFORMAT', 'DISPID_SVSpeak', 'ISpRecoGrammar',
    ...
    'SAFT48kHz8BitMono', 'DISPID_SpeechAudio', 'DISPID_SRRAlternates',
    'DISPID_SPRules_NewEnum', 'SPEI_START_SR_STREAM',
    'SAFT8kHz8BitMono', 'SRAExport', 'DISPID_SRRSaveToMemory',
    'SAFT24kHz8BitMono', 'SRERequestUI', 'DISPID_SGRSTs_NewEnum',
    'SAFTCCITT_ALaw_44kHzStereo', 'SREFalseRecognition',
    'SGDSActiveWithAutoPause', 'DISPID_SpeechRecoContextEvents',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SpeechVisemeType',
    'SRTReSent', 'SpeechCategoryPhoneConverters', 'ISpeechMMSysAudio',
    ...
    'DISPID_SLPsItem', 'SPBO_NONE', 'eLEXTYPE_PRIVATE9',
    'DISPID_SAEventHandle', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SPEI_WORD_BOUNDARY', 'SAFT48kHz16BitStereo',
    'DISPID_SPEDisplayText', 'SVSFVoiceMask', 'SAFT22kHz8BitMono',
    'ISpObjectToken', 'eWORDTYPE_DELETED', 'SAFTGSM610_44kHzMono',
    'SPWORDLIST', 'SVPOver', 'SpeechStreamFileMode', 'SRTSMLTimeout',
    'SpeechPropertyResponseSpeed', 'DISPID_SRGCmdLoadFromFile',
    'DISPID_SPPsCount', 'DISPID_SpeechRecoContext', 'SREAllEvents',
    'DISPID_SPRText', 'SAFT11kHz8BitStereo',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPRNumberOfElements',
    'SpUnCompressedLexicon', 'SAFT16kHz8BitStereo',
    'DISPIDSPTSI_SelectionOffset', 'SPEI_TTS_PRIVATE', 'SPSHT_EMAIL',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'ISpeechWaveFormatEx',
    'DISPID_SPEEngineConfidence', 'ISpeechMemoryStream',
    'SPEI_TTS_AUDIO_LEVEL', 'SPDKL_CurrentConfig', 'SRTEmulated',
    'DISPID_SRRTLength', 'SECFIgnoreKanaType', 'SPEI_SR_BOOKMARK',
    'DISPID_SGRSAddWordTransition', 'SAFT44kHz8BitMono',
    'SPEI_PROPERTY_STRING_CHANGE', 'SVF_None', 'SAFT22kHz16BitMono',
    'SPSUnknown', 'SP_VISEME_21', 'DISPID_SVEStreamStart',
    'SpeechLoadOption', 'SDKLCurrentUser', 'SVP_2',
    'DISPID_SPEs_NewEnum', 'SPSModifier',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRCERecognition', 'SASRun',
    'SAFT32kHz8BitMono', 'SAFTADPCM_44kHzMono', 'SRSEIsSpeaking',
    'SAFT22kHz16BitStereo', 'SAFT11kHz16BitMono',
    'SpeechAudioProperties', 'DISPID_SLWLangId', 'SPPS_Function',
    'eLEXTYPE_USER', 'SpTextSelectionInformation',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SLGetGenerationChange',
    'SSFMCreate', 'DISPID_SpeechRecoResult',
    'SAFTExtendedAudioFormat', 'DISPID_SLWs_NewEnum', 'SRATopLevel',
    'SpeechCategoryRecoProfiles', 'SpeechTokenKeyUI',
    'DISPID_SRCPause', 'LONG_PTR', 'DISPID_SpeechLexiconWord',
    'DISPID_SRSetPropertyNumber', 'SDTAll',
    'DISPID_SASCurrentSeekPosition', 'SpeechDictationTopicSpelling',
    'SPEI_RESERVED1', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SVEWord', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SPERetainedStreamOffset', 'SAFTCCITT_ALaw_11kHzStereo',
    'DISPID_SCSBaseStream', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRState', 'SDTRule', 'SPINTERFERENCE_NOISE',
    'SPWT_PRONUNCIATION', 'DISPID_SVEPhoneme', 'DISPID_SVSLastResult',
    'SpeechVoiceSkipTypeSentence', 'SINoSignal', 'SASStop',
    'SP_VISEME_14', 'DISPID_SpeechRecoResultTimes',
    'DISPID_SGRsCommitAndSave', 'DISPID_SOTMatchesAttributes',
    'DISPID_SOTsCount', 'SRADynamic', 'DISPID_SpeechAudioStatus',
    'SAFT32kHz8BitStereo', 'SDTLexicalForm',
    'SWPKnownWordPronounceable', 'SVPAlert', 'SAFT44kHz16BitMono',
    'DISPID_SRCEBookmark', 'SAFTNoAssignedFormat',
    'SpeechEngineProperties', 'SVSFParseSsml', 'SPSHORTCUTTYPE',
    'DISPID_SOTCSetId', 'SpeechRunState', 'SPPS_Unknown',
    'DISPID_SRRRecoContext', 'SVEAllEvents', 'SRSActive',
    'SPRECOSTATE', 'SPRECORESULTTIMES', 'SPEI_TTS_BOOKMARK',
    'SP_VISEME_12', 'ISpNotifySink', 'SPPS_Verb', 'ISpeechPhraseInfo',
    'SGPronounciation', 'DISPID_SVEventInterests', 'SLTUser',
    'DISPID_SPANumberOfElementsInResult', 'SBONone',
    'DISPID_SRGSetTextSelection', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPPHRASEREPLACEMENT', 'SREBookmark', 'SRSInactive', 'SVP_3',
    'SpeechAllElements', 'SVP_15', 'DISPID_SAVolume',
    'SPINTERFERENCE_TOOQUIET', 'SpObjectTokenCategory',
    'ISpeechAudioStatus', 'ISpObjectWithToken',
    'DISPID_SWFEBlockAlign', 'ISpProperties', 'SPAR_Unknown',
    'SpeechAudioFormatGUIDText', 'SPWT_LEXICAL', 'SP_VISEME_20',
    ...
    'SPCS_DISABLED', 'SpCompressedLexicon', 'STCAll', 'SPRST_ACTIVE',
    'SGDSActive', 'SPSMF_SRGS_SAPIPROPERTIES', 'SWTDeleted',
    'DISPID_SGRSTPropertyValue',
    'DISPID_SpeechGrammarRuleStateTransition',
    'ISpeechTextSelectionInformation', 'SpeechEngineConfidence',
    'eLEXTYPE_PRIVATE11', 'SPSTREAMFORMATTYPE', 'DISPID_SMSADeviceId',
    'SPPS_RESERVED1', 'SREPropertyStringChange',
    'DISPID_SRCVoicePurgeEvent', 'SECNormalConfidence',
    'DISPID_SPPParent', 'DISPID_SPAStartElementInResult',
    'SAFT24kHz8BitStereo', 'SPEVENTENUM', 'SREInterference',
    'SAFTCCITT_uLaw_44kHzMono', 'SPLO_STATIC',
    'DISPID_SRCESoundStart', 'DISPID_SABIEventBias',
    'DISPID_SVESentenceBoundary', 'DISPID_SRGetFormat',
    'SVSFPurgeBeforeSpeak', 'DISPID_SGRSTransitions',
    'DISPID_SVGetProfiles', 'ISpeechLexiconPronunciations',
    'DISPID_SRGSetWordSequenceData', 'SINone', 'DISPID_SGRs_NewEnum',
    'DISPID_SpeechCustomStream', 'DISPID_SRCEEnginePrivate',
    'DISPID_SRGState', '_ISpeechRecoContextEvents',
    'DISPID_SpeechPhraseProperty', 'SAFTCCITT_ALaw_8kHzStereo',
    'SPEI_PHONEME', 'DISPID_SRGCommit', 'SpeechCategoryAppLexicons',
    'SVP_0', 'DISPID_SRRSetTextFeedback', 'SLOStatic',
    'eLEXTYPE_PRIVATE18', 'DISPID_SBSRead', 'SpResourceManager',
    'DISPID_SGRSRule', 'SPSFunction', 'SPPHRASE', 'SPPARTOFSPEECH',
    'DISPID_SGRsCommit', 'SPRECOGNIZERSTATUS', 'SRESoundEnd',
    'DISPID_SPAsItem', 'ISpRecoGrammar2', 'SpStreamFormatConverter',
    'SRCS_Enabled', 'DISPID_SLAddPronunciation', 'SPAUDIOBUFFERINFO',
    'DISPID_SLPSymbolic', 'SpeechCategoryVoices', 'DISPID_SRProfile',
    'eLEXTYPE_PRIVATE6', 'DISPID_SpeechPhraseProperties',
    'SpeechTokenValueCLSID', 'DISPID_SVPause', 'ISequentialStream',
    'DISPID_SLWsCount', 'DISPID_SVWaitUntilDone',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SWFESamplesPerSec',
    'SPPS_RESERVED4', 'DISPID_SLGetWords', 'SAFTADPCM_11kHzStereo',
    'SPSMF_SAPI_PROPERTIES', 'SITooLoud',
    'SpeechSpecialTransitionType', 'DISPID_SRCEStartStream', 'SVP_8',
    'DISPID_SRCERequestUI', 'SAFTGSM610_8kHzMono',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SVEBookmark',
    'ISpeechLexiconWord', 'SPEI_SR_AUDIO_LEVEL',
    'SPADAPTATIONRELEVANCE', 'DISPID_SVAudioOutput', 'SPXRO_SML',
    'DISPID_SOTGetAttribute', 'SRAORetainAudio',
    'DISPID_SRGetRecognizers', 'SPSHT_NotOverriden', 'SPSLMA',
    'DISPID_SRSClsidEngine', 'SVP_16', 'DISPID_SVGetVoices',
    'ISpAudio', 'DISPID_SPEAudioSizeBytes', 'SREHypothesis',
    'DISPID_SRCVoice', 'SPEI_HYPOTHESIS', 'SPVPRI_NORMAL',
    'DISPID_SRRSpeakAudio', 'DISPID_SGRSTNextState', 'SREPrivate',
    'DISPID_SRRTStreamTime', 'DISPID_SOTDataKey', 'SPAR_Medium',
    'DISPID_SVAlertBoundary', 'SPPS_Interjection', 'SVSFNLPMask',
    'ISpXMLRecoResult', 'SITooSlow', 'tagSPPROPERTYINFO',
    'eLEXTYPE_USER_SHORTCUT', 'SPRECOCONTEXTSTATUS',
    'DISPID_SPPChildren', 'SVEEndInputStream', 'ISpRecognizer3',
    'ISpLexicon', 'DISPID_SDKSetStringValue', 'SpeechTokenContext',
    'DISPID_SRCSetAdaptationData', 'SVP_4', 'ISpeechLexicon',
    'SPFM_OPEN_READONLY', 'DISPID_SOTCDefault',
    'DISPID_SpeechDataKey', 'SpeechTokenShellFolder',
    'DISPID_SPISaveToMemory', 'DISPID_SRCreateRecoContext',
    'SPBO_AHEAD', 'ISpPhraseAlt', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SPEI_INTERFERENCE', 'ISpPhoneticAlphabetConverter',
    'SAFT8kHz16BitStereo', 'SVSFParseMask', 'SPAS_STOP',
    'DISPID_SRCRetainedAudioFormat', 'SRAONone', 'SDTAudio',
    'ISpeechAudioFormat', 'SpMMAudioIn', 'DISPID_SVStatus',
    'ISpeechGrammarRuleState', 'SpFileStream', 'ISpeechFileStream',
    'ISpNotifyTranslator', 'DISPID_SRCEHypothesis',
    'DISPID_SpeechPhraseInfo', 'SVEPrivate',
    'DISPID_SPPNumberOfElements', 'SPSSuppressWord',
    'DISPID_SPERequiredConfidence', 'SPSHT_Unknown',
    'ISpPhoneConverter', 'SpSharedRecognizer',
    'SAFTADPCM_44kHzStereo', 'DISPID_SVSpeakCompleteEvent', 'SVP_9',
    'ISpeechPhraseElements', 'DISPID_SBSWrite', 'SPFM_CREATE_ALWAYS',
    'DISPID_SVSVisemeId', 'DISPID_SRCRecognizer',
    'DISPID_SVAudioOutputStream', 'eLEXTYPE_PRIVATE16', 'SVSFDefault',
    'SPDATAKEYLOCATION', 'DISPID_SpeechObjectTokens',
    'eLEXTYPE_PRIVATE1', 'ISpeechPhraseProperties', 'SRAInterpreter',
    'SAFTADPCM_11kHzMono', '_SPAUDIOSTATE',
    'ISpeechGrammarRuleStateTransition', 'SPEI_SOUND_START',
    'DISPID_SPARecoResult', 'SGRSTTTextBuffer', 'SAFT11kHz8BitMono',
    'SPGS_EXCLUSIVE', 'ISpVoice', 'ISpResourceManager',
    'SpeechTokenIdUserLexicon', 'SP_VISEME_2',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SRAudioInput',
    'SpeechGrammarTagUnlimitedDictation', 'SVP_14', 'SpShortcut',
    'DISPID_SGRsCount', 'SpeechPartOfSpeech', 'SFTSREngine',
    'DISPID_SPIEnginePrivateData', 'DISPID_SOTRemoveStorageFileName',
    'eLEXTYPE_PRIVATE14', 'DISPID_SPRuleConfidence',
    'DISPID_SPPConfidence', 'SpeechAudioVolume', 'DISPID_SPRsCount',
    'SPWORDPRONOUNCEABLE', 'SAFT16kHz16BitStereo', 'SP_VISEME_17',
    'SPPHRASERULE', 'SAFT32kHz16BitMono', 'DISPID_SpeechGrammarRule',
    'SPSHT_OTHER', 'SVSFUnusedFlags', 'DISPID_SGRSTPropertyName',
    'SGSDisabled', 'DISPID_SLWWord', 'SRADefaultToActive',
    'Speech_StreamPos_Asap', 'SAFT16kHz8BitMono',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SOTCId',
    'DISPID_SVResume', 'SpCustomStream', 'SPSERIALIZEDRESULT',
    'DISPID_SVSLastBookmarkId', 'SPFM_OPEN_READWRITE',
    'ISpeechPhraseInfoBuilder', 'SAFTCCITT_ALaw_22kHzMono',
    'SDTAlternates', 'DISPID_SABufferInfo', 'SAFTNonStandardFormat',
    'SpeechRetainedAudioOptions', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SPRFirstElement', 'DISPID_SDKEnumValues',
    'DISPID_SpeechMMSysAudio', 'DISPID_SASetState', 'SPSMF_UPS',
    'SPPS_RESERVED2', 'SAFT32kHz16BitStereo', 'SDKLCurrentConfig',
    'DISPID_SRSNumberOfActiveRules', 'SpNotifyTranslator',
    'DISPID_SpeechRecognizerStatus', 'SPVOICESTATUS', 'SP_VISEME_6',
    'DISPID_SDKCreateKey', 'DISPID_SRCEPropertyStringChange',
    'SSSPTRelativeToEnd', 'SDKLLocalMachine',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SPCPhoneToId', 'SRARoot',
    'STSF_LocalAppData', 'SPEI_MAX_TTS',
    'DISPID_SPIRetainedSizeBytes', 'STSF_FlagCreate',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPXMLRESULTOPTIONS',
    'SAFT12kHz16BitMono', 'DISPID_SGRInitialState',
    'SSFMOpenReadWrite', 'ISpeechObjectTokenCategory', 'DISPIDSPTSI',
    'IInternetSecurityManager', 'DISPID_SOTId', 'eLEXTYPE_PRIVATE2',
    'SPLO_DYNAMIC', 'SPAS_PAUSE', 'SPEI_VOICE_CHANGE',
    'SAFTGSM610_22kHzMono', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SMSSetData', 'SGRSTTDictation', 'ISpStream',
    'ISpRecognizer', 'ISpShortcut', 'ISpeechPhraseElement',
    'SPPROPERTYINFO', 'SpWaveFormatEx', 'SVEVoiceChange',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SRCERecognizerStateChange', 'IEnumString', 'ISpeechVoice',
    'DISPID_SpeechPhraseBuilder', 'SpObjectToken',
    'DISPID_SDKGetStringValue', 'eLEXTYPE_RESERVED6',
    'eLEXTYPE_PRIVATE10', 'SRCS_Disabled', 'SpeechVoiceEvents',
    'ISpeechPhoneConverter', 'DISPID_SVGetAudioOutputs',
    '_ISpeechVoiceEvents', 'SPINTERFERENCE',
    'DISPID_SRCEPropertyNumberChange',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SAFGuid',
    'SGRSTTRule', 'DISPID_SOTRemove', 'SP_VISEME_5', 'IStream',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRSSupportedLanguages',
    'SGSExclusive', 'SPINTERFERENCE_LATENCY_WARNING',
    'ISpeechRecognizerStatus', 'SpeechDiscardType',
    ...
    'SPVPRI_OVER', 'SPCT_COMMAND', 'SP_VISEME_1', 'SPSNoun',
    'DISPID_SVVolume', 'DISPID_SRCCreateGrammar',
    'SpeechVoiceCategoryTTSRate', 'SPSHORTCUTPAIRLIST',
    'DISPID_SOTGetStorageFileName', 'DISPID_SGRAddResource',
    'SP_VISEME_10', 'SREPhraseStart', 'SDTPronunciation',
    'ISpDataKey', 'SPSNotOverriden', 'DISPID_SGRsDynamic',
    'SPGRAMMARWORDTYPE', 'DISPID_SLWType', 'SVP_18',
    'SpeechRecognizerState', 'SRTStandard',
    'SPRST_INACTIVE_WITH_PURGE', 'SPBOOKMARKOPTIONS',
    'DISPID_SLPLangId', 'DISPID_SDKSetBinaryValue', 'SECFDefault',
    'DISPID_SpeechPhraseRule', 'DISPID_SRRTTickCount',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SOTsItem', 'SPSERIALIZEDPHRASE',
    'SPAR_High', 'eLEXTYPE_PRIVATE13', 'SVSFIsFilename',
    'SpeechDataKeyLocation', 'SPSHORTCUTPAIR', 'DISPID_SPRuleParent',
    'ISpeechGrammarRuleStateTransitions', 'DISPIDSPTSI_ActiveLength',
    'SpeechRecoEvents', 'DISPID_SPCIdToPhone', 'DISPID_SVSPhonemeId',
    'SSTTWildcard', 'DISPID_SPEsItem', 'SpeechEmulationCompareFlags',
    'SpPhraseInfoBuilder', 'DISPIDSPRG', 'DISPID_SRIsShared',
    'SPPS_NotOverriden', 'SPWAVEFORMATTYPE', 'SAFTGSM610_11kHzMono',
    'DISPID_SPPFirstElement', 'DISPID_SLPPartOfSpeech',
    'SGDSInactive', 'eLEXTYPE_PRIVATE8', 'SAFTCCITT_ALaw_44kHzMono',
    'SPGS_DISABLED', 'Speech_Max_Pron_Length',
    'DISPID_SpeechPhoneConverter', 'DISPID_SRGRules',
    'SPCT_SUB_COMMAND', 'DISPID_SpeechObjectToken',
    'SPWORDPRONUNCIATIONLIST', 'SP_VISEME_8', 'DISPID_SGRAddState',
    'SAFTCCITT_uLaw_8kHzStereo', 'SGDSActiveUserDelimited',
    'DISPID_SGRsAdd', 'SPEI_RESERVED6',
    'DISPID_SVSCurrentStreamNumber', 'SP_VISEME_15',
    'SPPS_Noncontent', 'eLEXTYPE_PRIVATE3', 'SPRULESTATE',
    'DISPID_SpeechGrammarRules', 'SAFT48kHz16BitMono',
    'DISPID_SWFEFormatTag', 'SAFTCCITT_ALaw_11kHzMono', 'SGLexical',
    'SpeechBookmarkOptions', 'tagSTATSTG', 'DISPID_SpeechRecognizer',
    'DISPID_SRCERecognitionForOtherContext', 'ISpRecoCategory',
    '__MIDL_IWinTypes_0009', 'SAFT16kHz16BitMono', 'DISPID_SFSOpen',
    'DISPID_SPPValue', 'DISPID_SpeechLexicon', 'SPVPRIORITY',
    'DISPID_SRGDictationUnload', 'SpeechTokenKeyFiles',
    'DISPID_SOTCGetDataKey', 'SVP_10', 'SITooQuiet',
    'SpeechLexiconType', 'SPEI_UNDEFINED', 'IEnumSpObjectTokens',
    'SREPropertyNumChange', 'DISPID_SVEAudioLevel',
    'SpeechDisplayAttributes', 'SFTInput',
    'DISPID_SRGetPropertyString', 'SPTEXTSELECTIONINFO',
    'SVSFlagsAsync', 'SGDisplay', 'SPPS_Modifier',
    'SPEI_END_INPUT_STREAM', 'SPSEMANTICERRORINFO',
    'SpInProcRecoContext', 'SREAdaptation',
    'SWPUnknownWordUnpronounceable', 'DISPID_SGRSTType',
    'SPAO_RETAIN_AUDIO', 'SPFM_CREATE', 'DISPID_SABIMinNotification',
    'SP_VISEME_13', 'DISPID_SASFreeBufferSpace', 'SGSEnabled',
    'Speech_Max_Word_Length', 'SP_VISEME_19',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpeechPhraseRules', 'SINoise',
    'DISPID_SVRate', 'ISpeechPhraseReplacement', 'DISPID_SPRuleName',
    'DISPID_SRGIsPronounceable', 'STCInprocHandler',
    'DISPID_SVSInputWordPosition', 'SGRSTTWildcard',
    'Speech_Default_Weight', 'DISPID_SpeechVoiceEvent',
    'SPRST_ACTIVE_ALWAYS', 'SPLEXICONTYPE', 'SPWORDTYPE',
    'ISpeechAudio', 'DISPID_SpeechPhraseRules',
    'DISPID_SVIsUISupported', 'SBOPause', 'DISPID_SpeechVoice',
    'SGLexicalNoSpecialChars', 'DISPID_SREmulateRecognition',
    'DISPID_SPPs_NewEnum', 'ISpStreamFormat', 'SPEVENTSOURCEINFO',
    'SP_VISEME_16', 'STCRemoteServer', 'SAFTText',
    'ISpeechObjectToken', 'SAFT12kHz8BitMono', 'eLEXTYPE_PRIVATE4',
    'DISPID_SBSSeek', 'SAFT8kHz8BitStereo',
    'ISpPhoneticAlphabetSelection', 'DISPID_SGRId',
    'DISPID_SRRecognizer', 'SRSActiveAlways', 'SRTExtendableParse',
    'SPBO_TIME_UNITS', 'SVF_Stressed', 'SVP_13',
    'DISPID_SOTGetDescription', 'SAFT48kHz8BitStereo',
    'DISPID_SOTDisplayUI', 'DISPID_SDKGetBinaryValue',
    'ISpeechDataKey', 'DISPID_SVEBookmark', 'SGRSTTEpsilon',
    'SPEI_RECO_OTHER_CONTEXT', 'SRSEDone', 'SPCATEGORYTYPE',
    'SpeechGrammarTagDictation', 'DISPID_SVEViseme', 'DISPID_SVSkip',
    'SVP_11', 'DISPID_SMSALineId', 'SVP_17', 'SPFM_NUM_MODES',
    'SSTTTextBuffer', 'DISPID_SVSLastStreamNumberQueued',
    'SP_VISEME_18', 'SpeechAudioFormatType', 'SVEViseme',
    'ISpeechRecognizer', 'SPINTERFERENCE_TOOLOUD', 'DISPID_SLPType',
    'ISpRecoResult', 'SpMMAudioEnum', 'ISpRecognizer2',
    'eLEXTYPE_PRIVATE19', 'SVSFPersistXML', 'SVPNormal',
    'SVF_Emphasis', 'SAFT24kHz16BitStereo', 'SPPHRASEPROPERTY',
    'SpMMAudioOut', 'ISpeechRecoResult2', 'SPPS_Noun',
    'DISPID_SPEAudioTimeOffset', 'SRERecoOtherContext',
    'SAFTCCITT_uLaw_8kHzMono', 'SAFTADPCM_8kHzMono', 'SPEVENT',
    'SpeechRuleAttributes', 'DISPID_SGRClear',
    'DISPID_SDKGetlongValue', 'DISPID_SRRPhraseInfo',
    'DISPID_SVVoice', 'DISPID_SGRSTsItem', 'DISPID_SDKEnumKeys',
    'SPINTERFERENCE_NONE', 'DISPID_SpeechMemoryStream',
    'DISPID_SAStatus', 'DISPID_SRCAudioInInterferenceStatus',
    'ISpeechRecoResult', 'SPEI_SR_PRIVATE',
    'DISPID_SRCRequestedUIType', 'DISPID_SOTs_NewEnum',
    'SAFT44kHz8BitStereo', 'SPRST_INACTIVE', 'STSF_CommonAppData',
    'DISPID_SGRAttributes',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SpeechStreamSeekPositionType', 'SRTAutopause',
    'eLEXTYPE_RESERVED7', 'DISPID_SRCBookmark',
    ...
    'SREStreamEnd', 'DISPID_SpeechXMLRecoResult', 'ISpeechBaseStream',
    'SPRS_INACTIVE', 'DISPID_SLPsCount',
    'DISPID_SRCCreateResultFromMemory', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPEI_REQUEST_UI', 'SpMemoryStream', 'SpeechRegistryUserRoot',
    'DISPID_SRGetPropertyNumber', 'ISpEventSink',
    'DISPID_SOTCategory', 'DISPID_SPIGrammarId',
    'SpeechVoiceSpeakFlags', 'DISPID_SPEsCount',
    'SAFTCCITT_uLaw_11kHzStereo', 'SPEI_SR_RETAINEDAUDIO',
    'SPWF_INPUT', 'SVP_5', 'SASClosed', 'SREAudioLevel',
    'SPPHRASEELEMENT', 'DISPID_SPIRule', 'DISPID_SVEVoiceChange',
    'DISPID_SPEDisplayAttributes', 'eLEXTYPE_PRIVATE5',
    'DISPID_SGRsFindRule', 'SDTProperty', 'eLEXTYPE_LETTERTOSOUND',
